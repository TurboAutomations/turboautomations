  ...
  return (
    <section className="space-y-6 py-32 md:py-48 lg:py-52">
      <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
        {props.capsuleText && props.capsuleLink && (
          <Link
        ...
        <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">{props.subtitle}</p>
        <div className="flex gap-4 flex-wrap justify-center">
          ...
          <Link href={props.secondaryCtaLink} className={cn(buttonVariants({ variant: "outline", size: "lg" }))}>
